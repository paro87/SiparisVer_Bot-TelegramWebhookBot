...
public class HelpHandler implements MenuHandler {
    ...
    public HelpHandler(UserService userService, ReplyMessageService messagesService, MainMenuService mainMenuService) {
    ...
    private SendMessage processUsersInput(Message inputMsg) {
        ...
        SendMessage sendMessage = messagesService.getReplyMessage(callbackAnswer,"reply.help");
        userService.setUsersCurrentBotState(userId, BotState.HELP);
        return sendMessage;
    }
}
